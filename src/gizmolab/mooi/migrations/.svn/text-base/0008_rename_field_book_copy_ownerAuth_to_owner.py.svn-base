...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename 'Book_Copy.ownerAuth' field to 'Book_Copy.owner'
        db.rename_column('mooi_book_copy', 'ownerAuth_id', 'owner_id')


    def backwards(self, orm):
        # Rename 'Book_Copy.owner' field to 'Book_Copy.ownerAuth'
        db.rename_column('mooi_book_copy', 'owner_id', 'ownerAuth_id')
