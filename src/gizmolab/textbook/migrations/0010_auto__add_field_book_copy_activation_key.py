...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Book_Copy.activation_key'
        db.add_column('textbook_book_copy', 'activation_key', self.gf('django.db.models.fields.CharField')(max_length=40, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Book_Copy.activation_key'
        db.delete_column('textbook_book_copy', 'activation_key')
