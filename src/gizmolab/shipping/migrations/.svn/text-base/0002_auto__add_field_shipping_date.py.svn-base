...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Shipping.date'
        db.add_column('shipping_shipping', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2011, 4, 2, 20, 40, 11, 538220), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Shipping.date'
        db.delete_column('shipping_shipping', 'date')
