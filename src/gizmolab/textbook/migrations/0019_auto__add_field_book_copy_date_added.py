...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Book_Copy.date_added'
        db.add_column('textbook_book_copy', 'date_added', self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.date(1901, 1, 1), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Book_Copy.date_added'
        db.delete_column('textbook_book_copy', 'date_added')
