...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('textbook_subject', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['textbook.Subject'])),
            ('lft', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('rght', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('level', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ))
        db.send_create_signal('textbook', ['Subject'])

        # Adding M2M table for field subjects on 'Book'
        db.create_table('textbook_book_subjects', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('book', models.ForeignKey(orm['textbook.book'], null=False)),
            ('subject', models.ForeignKey(orm['textbook.subject'], null=False))
        ))
        db.create_unique('textbook_book_subjects', ['book_id', 'subject_id'])


    def backwards(self, orm):
        
        # Deleting model 'Subject'
        db.delete_table('textbook_subject')

        # Removing M2M table for field subjects on 'Book'
        db.delete_table('textbook_book_subjects')
