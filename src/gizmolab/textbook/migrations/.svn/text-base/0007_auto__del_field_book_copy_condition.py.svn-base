...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Book_Copy.condition'
        db.delete_column('textbook_book_copy', 'condition')


    def backwards(self, orm):
        
        # Adding field 'Book_Copy.condition'
        db.add_column('textbook_book_copy', 'condition', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=2, decimal_places=1), keep_default=False)
