...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Book.discipline'
        db.delete_column('textbook_book', 'discipline')


    def backwards(self, orm):
        
        # Adding field 'Book.discipline'
        db.add_column('textbook_book', 'discipline', self.gf('django.db.models.fields.CharField')(default='Other', max_length=50, blank=True), keep_default=False)
