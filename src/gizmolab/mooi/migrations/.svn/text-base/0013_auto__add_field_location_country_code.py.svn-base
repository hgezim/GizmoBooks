...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('mooi_location', 'country_code', self.gf('django.db.models.fields.CharField')(default='', max_length=5, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Location.country_code'
        db.delete_column('mooi_location', 'country_code')
