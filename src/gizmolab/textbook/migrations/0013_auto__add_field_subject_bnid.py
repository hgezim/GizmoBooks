...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subject.bnid'
        db.add_column('textbook_subject', 'bnid', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Subject.bnid'
        db.delete_column('textbook_subject', 'bnid')
