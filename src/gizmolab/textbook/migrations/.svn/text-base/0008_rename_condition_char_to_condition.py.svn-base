...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Rename 'Book_Copy.condition_char' field to 'Book_Copy.condition'
        db.rename_column('textbook_book_copy', 'condition_char', 'condition')


    def backwards(self, orm):
        # Rename 'Book_Copy.condition' field to 'Book_Copy.condition_char'
        db.rename_column('textbook_book_copy', 'condition', 'condition_char')
