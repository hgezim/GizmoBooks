...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Book_Copy.buying_options'
        db.delete_column('textbook_book_copy', 'buying_options')


    def backwards(self, orm):
        
        # Adding field 'Book_Copy.buying_options'
        db.add_column('textbook_book_copy', 'buying_options', self.gf('django.db.models.fields.CharField')(default='1', max_length=1), keep_default=False)
