...
class PayPalPaymentsForm(forms.Form):
    ...
    #shopping cart stuff
    # modified by Gezim to allow shopping carts
    upload = forms.IntegerField(widget=ValueHiddenInput())
    item_name_1 = forms.CharField(widget=ValueHiddenInput())
    item_number_1 = forms.CharField(widget=ValueHiddenInput())
    amount_1 = forms.IntegerField(widget=ValueHiddenInput())
    shipping_1 = forms.IntegerField(widget=ValueHiddenInput())
