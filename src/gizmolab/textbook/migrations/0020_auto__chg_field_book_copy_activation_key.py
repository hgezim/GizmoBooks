...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Book_Copy.activation_key'
        db.alter_column('textbook_book_copy', 'activation_key', self.gf('django.db.models.fields.CharField')(max_length=40))


    def backwards(self, orm):
        
        # Changing field 'Book_Copy.activation_key'
        db.alter_column('textbook_book_copy', 'activation_key', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))
    ...
    models = {
        ...
        'textbook.book': {
            ...
            'picture': ('django.db.models.fields.files.ImageField', [], {'default': "'books/noimage.png'", 'max_length': '100'}),
