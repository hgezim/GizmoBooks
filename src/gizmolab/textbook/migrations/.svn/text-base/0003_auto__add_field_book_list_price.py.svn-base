...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Book.list_price'
        db.add_column('textbook_book', 'list_price', self.gf('django.db.models.fields.FloatField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Book.list_price'
        db.delete_column('textbook_book', 'list_price')
