...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Book_Copy.owner'
        db.delete_column('mooi_book_copy', 'owner_id')


    def backwards(self, orm):
        
        # Adding field 'Book_Copy.owner'
        db.add_column('mooi_book_copy', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(default='mooiOwner', to=orm['mooi.User']), keep_default=False)
