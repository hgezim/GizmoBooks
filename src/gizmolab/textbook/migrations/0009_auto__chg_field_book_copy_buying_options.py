...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Book_Copy.buying_options'
        db.alter_column('textbook_book_copy', 'buying_options', self.gf('django.db.models.fields.CharField')(max_length=1))


    def backwards(self, orm):
        
        # Changing field 'Book_Copy.buying_options'
        db.alter_column('textbook_book_copy', 'buying_options', self.gf('django.db.models.fields.IntegerField')())
