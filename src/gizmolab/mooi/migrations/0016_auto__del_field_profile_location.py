...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('mooi_profile', 'location_id')


    def backwards(self, orm):
        
        # Adding field 'Profile.location'
        db.add_column('mooi_profile', 'location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mooi.Location'], null=True), keep_default=False)
